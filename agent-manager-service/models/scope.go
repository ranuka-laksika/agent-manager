...
// Scope is an org-global, resource-agnostic scope name. Scopes gate MCP proxy
// tools (and later LLM providers); AMS stores only the catalog — grants live in
// each environment's Thunder instance.
type Scope struct {
