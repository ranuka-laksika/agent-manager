  ...
  build: {
    ...
    rollupOptions: {
      external: [
        ...
        '@asgardeo/react',
        // Workspace page packages - externalized to reduce bundle size
        '@agent-management-platform/add-new-agent',
        '@agent-management-platform/add-new-project',
        '@agent-management-platform/build',
        '@agent-management-platform/deploy',
        '@agent-management-platform/overview',
        '@agent-management-platform/configure-agent',
        '@agent-management-platform/agent-security',
        '@agent-management-platform/test',
        '@agent-management-platform/traces',
        '@agent-management-platform/logs',
        '@agent-management-platform/metrics',
        '@agent-management-platform/eval',
        '@agent-management-platform/llm-providers',
        '@agent-management-platform/gateways',
        // Workspace library packages
        '@agent-management-platform/auth',
        '@agent-management-platform/api-client',
        '@agent-management-platform/shared-component',
        '@agent-management-platform/types',
        '@agent-management-platform/views',
      ],
    },
  },
})
