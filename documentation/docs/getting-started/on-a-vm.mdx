...
flowchart TB
    ...
    subgraph vm["VM (only :443 is public)"]
        ...
        subgraph k3d["k3d cluster (host ports bound to 127.0.0.1)"]
            ...
            cp["Gateway control plane :9243<br/>(external AI gateways)"]
    ...
    caddy -->|"console.amp.&lt;IP&gt;.sslip.io<br/>api.amp.&lt;IP&gt;.sslip.io<br/>thunder.amp.&lt;IP&gt;.sslip.io"| cpgw
