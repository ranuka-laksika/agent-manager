...
flowchart TB
    ...
    subgraph vm["VM (only :443 is public)"]
        ...
        subgraph k3d["k3d cluster (host ports bound to 127.0.0.1)"]
            console["Console<br/>CP gateway :8080"]
            api["amp-api<br/>CP gateway :8080"]
            thunder["Thunder OAuth<br/>CP gateway :8080"]
            observer["Traces Observer<br/>OP gateway :11080"]
            gw["Gateway · OTel ingest<br/>DP gateway :19080"]
            cp["Gateway control plane<br/>:9243"]
            agents["Deployed agents<br/>DP gateway :19080"]
        end
    end
