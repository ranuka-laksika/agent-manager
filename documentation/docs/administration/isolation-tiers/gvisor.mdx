...
Isolation tier is set at environment creation time. Open the **Add Environment** drawer in the console (Deployment Pipelines → Environments), copy the generated command, and add `ISOLATION_TIER=gvisor`:
