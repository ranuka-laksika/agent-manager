...
|-----------|---------------------|
| **Build Plane** | [values-bp.yaml](https://raw.githubusercontent.com/wso2/agent-manager/amp/v0.7.0-rc4/deployments/single-cluster/values-bp.yaml) |
| **Observability Plane** | [values-op.yaml](https://raw.githubusercontent.com/wso2/agent-manager/amp/v0.7.0-rc4/deployments/single-cluster/values-op.yaml) |
| **Control Plane** | [values-cp.yaml](https://raw.githubusercontent.com/wso2/agent-manager/amp/v0.7.0-rc4/deployments/single-cluster/values-cp.yaml) |
| **Data Plane** | [values-dp.yaml](https://raw.githubusercontent.com/wso2/agent-manager/amp/v0.7.0-rc4/deployments/single-cluster/values-dp.yaml) |
...
helm install openchoreo-control-plane \
  ...
  --create-namespace \
  --timeout 600s \
  --values https://raw.githubusercontent.com/wso2/agent-manager/amp/v0.7.0-rc4/deployments/single-cluster/values-cp.yaml
...
helm install openchoreo-data-plane \
  ...
  --create-namespace \
  --timeout 600s \
  --values https://raw.githubusercontent.com/wso2/agent-manager/amp/v0.7.0-rc4/deployments/single-cluster/values-dp.yaml
...
helm install openchoreo-build-plane \
  ...
  --namespace openchoreo-build-plane \
  --timeout 600s \
  --values https://raw.githubusercontent.com/wso2/agent-manager/amp/v0.7.0-rc4/deployments/single-cluster/values-bp.yaml
...
kubectl apply -f https://raw.githubusercontent.com/wso2/agent-manager/amp/v0.7.0-rc4/deployments/values/oc-collector-configmap.yaml \
...
helm install openchoreo-observability-plane \
  ...
  --timeout 900s \
  --values https://raw.githubusercontent.com/wso2/agent-manager/amp/v0.7.0-rc4/deployments/single-cluster/values-op.yaml
...
```bash
# Apply Gateway Operator configuration
kubectl apply -f https://raw.githubusercontent.com/wso2/agent-manager/amp/v0.7.0-rc4/deployments/values/api-platform-operator-full-config.yaml
```
...
kubectl apply -f https://raw.githubusercontent.com/wso2/agent-manager/amp/v0.7.0-rc4/deployments/values/obs-gateway.yaml
...
kubectl apply -f https://raw.githubusercontent.com/wso2/agent-manager/amp/v0.7.0-rc4/deployments/values/otel-collector-rest-api.yaml
...
- **Control Plane Values**: [deployments/single-cluster/values-cp.yaml](https://raw.githubusercontent.com/wso2/agent-manager/amp/v0.7.0-rc4/deployments/single-cluster/values-cp.yaml)
- **Data Plane Values**: [deployments/single-cluster/values-dp.yaml](https://raw.githubusercontent.com/wso2/agent-manager/amp/v0.7.0-rc4/deployments/single-cluster/values-dp.yaml)
- **Build Plane Values**: [deployments/single-cluster/values-bp.yaml](https://raw.githubusercontent.com/wso2/agent-manager/amp/v0.7.0-rc4/deployments/single-cluster/values-bp.yaml)
- **Observability Plane Values**: [deployments/single-cluster/values-op.yaml](https://raw.githubusercontent.com/wso2/agent-manager/amp/v0.7.0-rc4/deployments/single-cluster/values-op.yaml)
- **Gateway Operator Config**: [deployments/values/api-platform-operator-full-config.yaml](https://raw.githubusercontent.com/wso2/agent-manager/amp/v0.7.0-rc4/deployments/values/api-platform-operator-full-config.yaml)
- **Observability Gateway**: [deployments/values/obs-gateway.yaml](https://raw.githubusercontent.com/wso2/agent-manager/amp/v0.7.0-rc4/deployments/values/obs-gateway.yaml)
- **OTEL Collector ConfigMap**: [deployments/values/oc-collector-configmap.yaml](https://raw.githubusercontent.com/wso2/agent-manager/amp/v0.7.0-rc4/deployments/values/oc-collector-configmap.yaml)
- **OTEL Collector RestApi**: [deployments/values/otel-collector-rest-api.yaml](https://raw.githubusercontent.com/wso2/agent-manager/amp/v0.7.0-rc4/deployments/values/otel-collector-rest-api.yaml)
